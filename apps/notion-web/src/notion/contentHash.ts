// Ported verbatim from apps/desktop/src/notion/contentHash.ts.
// Canonicalizes Notion markdown so harmless serialization / spacing / rotated
// signed-media-URL differences don't register as local edits.
import {
